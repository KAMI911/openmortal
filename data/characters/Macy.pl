...
@Frames = LoadFrames( "$codename.dat.txt", 316, 90 );
...
{ 'N'=>'Fun',			'DEL'=>7,	'S'=>'+fun,-fun', 'CON'=>$Con, 'SITU'=>'Ready' },
{ 'N'=>'Threat',		'DEL'=>7,	'S'=>'threat 2-n, threat n-2', 'CON'=>$Con, 'SITU'=>'Ready' },
